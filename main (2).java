...
//constructor for a Customer node
...
class BST_Club{
	...
	void search() {
	    ...
	    String key = sc.nextLine(); // Read artist name
	    sc.nextLine();
...
this.club = club;
 ...
 class Student{
		...
		long stud_phone;
		Student next;
		Student(String stud_name, String stud_dept, String stud_year,long stud_phone){
...
public class main {
	...
	public static void main(String[] args) {
		...
		bs.create("code club", "technical", "DSA stuff", "codeclubhead");
		bs.create("Loop", "Technical", "Coding", "loopclubhead");		
		 Events ob=new Events();
         ob.enqueue("Buffer","Technical","Mech Audi","12-05-2024","SY", "Loop"); 
